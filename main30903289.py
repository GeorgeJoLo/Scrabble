...
class guidelines:
    """
    Τα αρχεια ειναι τα: "main30903289.py" που περιλαμβάνει το κύριο πρόγραμμα , "classes.py" που περιλαμβάνει τις
    κλάσεις της εργασίας και "greek7.txt" που περιέχει τις λέξεις της ελληνικής γλώσσας που έχουν μέχρι και 7 γράμματα.
